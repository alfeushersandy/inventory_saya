@extends('layouts.office.master', ['title' => 'Produk'])

@section('content')
    <x-container>
        <div class="col-12">
            @can('product-create')
                <a href="{{ route('office.product.create') }}" class="btn btn-dark mb-2">
            ...
            @endcan
            <x-card-action title="Daftar Produk" url="{{ route('office.product.index') }}">
                <x-table>
                    <thead>
                        <tr>
                            <th>#</th>
